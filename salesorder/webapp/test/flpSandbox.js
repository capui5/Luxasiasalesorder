		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Sales Order",
									"targetURL": "#comluxasiasalesorder-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comluxasiasalesorder-display": {
								"semanticObject": "comluxasiasalesorder",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.luxasia.salesorder",
									"url": sap.ui.require.toUrl("com/luxasia/salesorder")
								}
							}
						}
					}
